# Copied from nixpkgs.
#
# This is a variation of the buildGoModule that uses __noChroot
...
, modRoot ? "./"
  ...
  #
  # if vendorHash is "heretic", we use __noChroot
, vendorHash ? "heretic"
...
let
  args = removeAttrs args' [ "overrideModAttrs" "vendorHash" ];

  moduleHash =
    if vendorHash == "heretic" then
      {
        __noChroot = true;
      }
    else
  ...
  } // moduleHash)).overrideAttrs overrideModAttrs;
